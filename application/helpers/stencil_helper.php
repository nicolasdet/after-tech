...
if (!function_exists('favicons'))
{
	function favicons($icons = NULL)
	{
		if ($icons == NULL)
		{
			...
			return '<link rel="icon" href="'.base_url('assets/img/icones/favicon-32.png').'" type="image/png"'.'><!-- default favicon -->'."\n\t".
			'<link rel="shortcut icon" href="'.base_url('assets/img/icones/favicon.ico').'"><!-- legacy default favicon (in root, 32x32) -->'."\n\t".
			...
			'<meta name="msapplication-config" content="'.base_url('assets/img/icons/browserconfig.xml').'">'."\n\t".
			'<link rel="apple-touch-icon" sizes="180x180" href="'.base_url('assets/img/icones/apple-touche-icon.png').'"><!-- iPad hi-res -->'."\n";
		}
